...
export const metadata: Metadata = {
  ...
  title: {
    default: "NMC Technology | Solar Power Installation in Lagos, Nigeria",
  ...
  keywords: [
    ...
    "solar power Nigeria",
    "inverter and battery system Lagos",
    "off-grid solar system",
    "lithium battery inverter Lagos",
    "solar panel installer Nigeria",
    "NMC Technology",
  ],
  ...
  openGraph: {
    ...
    url: site.domain,
    siteName: site.name,
    title: "NMC Technology | Premium Solar Power Systems in Lagos",
    description: site.description,
